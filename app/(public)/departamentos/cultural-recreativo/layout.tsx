...
const rota = ROTAS_PUBLICAS['/departamentos/cultural-recreativo'];

export const metadata: Metadata = {
  title: rota.titulo,
  description: rota.descricao,
  alternates: { canonical: '/departamentos/cultural-recreativo' },
  openGraph: {
    title: rota.titulo,
    description: rota.descricao,
    url: '/departamentos/cultural-recreativo',
  },
};
