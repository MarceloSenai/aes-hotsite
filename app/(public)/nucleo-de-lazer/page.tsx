...
export default function NúcleosDeLazerPage() {
 ...
 />
 <motion.div
 className="absolute w-[400px] h-[400px] bg-theme-primary-10 rounded-full blur-[80px]"
 ...
 <div className="relative h-full overflow-hidden rounded-2xl bg-white dark:bg-gray-800 border border-gray-200/80 dark:border-gray-700/60 transition-all duration-300 hover:shadow-2xl hover:shadow-theme-glow hover:border-theme-primary-light dark:hover:border-theme-primary-dark hover:-translate-y-2">
 {/* Card Header with gradient */}
 <div className="relative h-48 p-6 flex flex-col justify-between" style={{ background: nucleo.gradient }}>
 ...
 <div className="p-3 bg-theme-primary-light dark:bg-theme-primary-20 rounded-xl shrink-0">
 <Users size={24} className="text-theme-primary dark:text-theme-primary" />
 </div>
 <div>
 ...
 <div className="flex items-start gap-4">
 <div className="p-3 bg-theme-primary-light dark:bg-theme-primary-20 rounded-xl shrink-0">
 <Phone size={24} className="text-theme-primary dark:text-theme-primary" />
 </div>
 <div>
 <h3 className="font-bold text-gray-900 dark:text-white mb-1">
 ...
 <div className="flex items-start gap-4">
 <div className="p-3 bg-theme-primary-light dark:bg-theme-primary-20 rounded-xl shrink-0">
 <MapPin size={24} className="text-theme-primary dark:text-theme-primary" />
 </div>
 <div>
 <h3 className="font-bold text-gray-900 dark:text-white mb-1">
