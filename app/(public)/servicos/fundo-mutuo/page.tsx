      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200/80 dark:border-gray-700/60 p-8 hover:shadow-lg hover:shadow-green-500/5 transition-all duration-300"
          >
            <div className="flex items-center gap-4 mb-6">
