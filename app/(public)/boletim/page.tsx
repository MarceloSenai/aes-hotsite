...
const edicoes: Edicao[] = [
  { numero: 48, titulo: 'Boletim AES - Marco 2026', data: 'Marco 2026', resumo: 'Novas parcerias, calendario de eventos atualizado e informacoes sobre reservas nos nucleos de lazer.' },
  ...
  { numero: 46, titulo: 'Boletim AES - Janeiro 2026', data: 'Janeiro 2026', resumo: 'Posse da nova gestao 2026-2030, confraternizacao de inicio de ano e balanco 2025.' },
  { numero: 45, titulo: 'Boletim AES - Dezembro 2025', data: 'Dezembro 2025', resumo: 'Encerramento do ano, festa de confraternizacao e prestacao de contas anual.' },
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl">
            Acompanhe as edicoes do Boletim Informativo da AES com noticias, comunicados e informacoes relevantes para os associados.
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="flex-1">
              ...
              <p className="text-white/80 text-sm">Cadastre-se para receber as proximas edicoes diretamente no seu e-mail.</p>
            </div>
            <a
