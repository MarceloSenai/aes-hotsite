...
const documentSections = [
 ...
 gradient: 'linear-gradient(to right, var(--color-primary), var(--color-primary-dark))',
...
export default function DocumentosPage() {
 ...
 {/* Section Header */}
 <div className="relative p-6 sm:p-8" style={{ background: section.gradient }}>
 ...
 <div className="flex items-center gap-2 text-theme-primary dark:text-theme-primary opacity-0 group-hover/item:opacity-100 transition-opacity duration-200">
 <Download size={18} />
 </div>
 </div>
 ))}
 ...
 <button className="inline-flex items-center gap-2 text-theme-primary dark:text-theme-primary font-semibold text-sm hover:gap-3 transition-all duration-300">
